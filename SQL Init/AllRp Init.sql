...
engine = ReplicatedMergeTree('/clickhouse/tabkes/all-replicated/ds_dim_weather_data_v2', '{replica}')
...
engine = ReplicatedMergeTree('/clickhouse/tabkes/all-replicated/ds_buffer_translated_weather_data_v2', '{replica}')
ORDER BY (id, owd_id);
...
engine = ReplicatedMergeTree('/clickhouse/tabkes/all-replicated/ds_dim_translated_weather_data_v2', '{replica}')
ORDER BY (id, ds_id, owd_id)
